...
export const NavBar: FC<{ pdf: Blob }> = ({ pdf }) => {
   ...
   return (
      <div className='max-w-screen-sm mx-auto flex justify-between py-2 px-4 '>
         ...
         <div className="flex">
            ...
            <a className="ml-4 no-underline font-semibold text-gray-600 hover:text-gray-900" href="https://github.com/alleqs/faq.git">
